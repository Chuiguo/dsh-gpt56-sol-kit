 ...
 */
export function availableReasoningEffort(target, supported, defaultEffort) {
    if (target === null)
 ...
 */
export function resolveRequestOverrides(input) {
...
export function initialModeState(defaultMode) {
