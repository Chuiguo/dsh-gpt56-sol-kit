 ...
 */
export declare function pricesKnown(prices: PriceConfig): boolean;
/**
 ...
 */
export declare function computeCost(usage: Usage, prices: PriceConfig): number | null;
 ...
 */
export declare function budgetDecision(requestCost: number, sessionCost: number, requestBudget: number | null, sessionBudget: number | null): BudgetDecision;
