...
import { deniedCategoriesForMode, deniedToolsForMode, isMutatingTool } from "./tool-policy.js";
...
import { createWorkflow, transition } from "./workflow.js";
import { resolveCapabilities } from "./capabilities.js";
import { evaluateBudget } from "./budget-v2.js";
import { resolveEffectivePolicy } from "./effective-policy.js";
import { assessVerification, looksLikeCredentialLeak } from "./verify.js";
import { classifyFailure } from "./preflight.js";
    ...
    ctx.on('session/event', (session, event) => {
        ...
        if (event.type === 'tool/result') {
            ...
            if (state.workflow.phase === 'implement' && event.data.error === undefined) {
                ...
                const next = state.workflow.fixRounds < runtimeConfig.maxFixRounds ? 'fix' : 'blocked';
    ...
    function handleSolCommand(invocation) {
        ...
        switch (command.action) {
            ...
            case 'verify': {
                ...
                const resultForCall = (call) => successfulResultIds.has(call.data.callId);
