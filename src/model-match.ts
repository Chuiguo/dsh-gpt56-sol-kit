 ...
 */
export function matchesAnyModel(model: string, patterns: readonly string[]): boolean {
 ...
 */
export function matchesProvider(provider: string, providerPattern: string): boolean {
 ...
 */
export function isSolRoute(
  provider: string,
  model: string,
  config: { enabled: boolean; providerPattern: string; modelPatterns: readonly string[] },
): boolean {
 ...
 * @returns Whether the model matches.
 */
export function isSolModel(model: string, patterns: readonly string[]): boolean {
